...
@section('title', 'NextGen - ' . $entreprise->nom_entreprise)
...
@section('content')
    ...
    <style>
        /* Désactive le centrage et la largeur max pour cette page */
        .job-detail-section .upper-box,
        .job-detail-section .auto-container,
        .job-detail-section .job-block-seven.style-three,
        .job-detail-section .inner-box,
        .job-detail-section .entreprise-header {
