                    ...
                    <div class="col-lg-6">
                        <div class="sec-title -type-2 text-center">
                            ...
                            <div class="text">Avant de pouvoir activer votre compte sur notre plateforme, veuillez remplir
                                le formulaire suivant pour que nous puissions entrer en contact avec vous.</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="contact-form default-form">
                    <form method="post" action="{{ route('entreprise.store') }}" id="email-form">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 form-group">
                                <label>Numéro de Téléphone du Contact</label>
                                <input type="text" name="contact_phone" placeholder="Numéro de Téléphone du Contact"
                                    required>
                            </div>
                            ...
                            <div class="col-lg-12 form-group">
                                ...
                                <div class="checkbox-group">
                                    @foreach ($contrats as $contrat)
                                        <label><input type="checkbox" name="contrats[]" value={{ $contrat->id }}>
                                            {{ $contrat->nom_contrat }}</label>
                                    @endforeach
                                </div>
                            </div>
                            ...
                            <div class="col-lg-12 form-group">
                                ...
                                <div class="checkbox-group">
                                    ...
                                    @foreach ($domaines as $domaine)
                                        <label><input type="checkbox" name="domaines[]" value={{ $domaine->id }}>
                                            {{ $domaine->nom_domaine }}</label>
                                    @endforeach
                                    <!-- Ajouter d'autres domaines ici -->
                                </div>
                            </div>
                            ...
                            <div class="col-lg-12 form-group">
                                ...
                                <div class="checkbox-group">
                                    <label><input type="checkbox" name="inclusion_diversity[]"
                                        ...
                                        Chances</label>
                                    <label><input type="checkbox" name="inclusion_diversity[]"
                                            value="Programmes pour Groupes Sous-représentés"> Programmes pour Groupes
                            ...
                            <div class="col-lg-12 form-group">
                                ...
                                <div class="checkbox-group">
                                    ...
                                    <label><input type="checkbox" name="training_support[]"
                                            value="Programmes de Certification"> Programmes de Certification</label>
                                </div>
                            </div>
                            <<<<<<< HEAD <div class="text mb-4 mt-2">En remplissant ce formulaire, vous acceptez d'être
                                contacté par NextGen à des fins d'informations et de marketing, conformément à notre <a
                                    href="#">politique de protection des données personnelles</a>.
                        </div>

                        =======

                        <div class="text mb-4 mt-2">En remplissant ce formulaire, vous acceptez d'être contacté par NextGen
                            à des fins d'informations et de marketing, conformément à notre <a href="#">politique de
                                protection des données personnelles</a>.</div>

                        >>>>>>> master
                        <div class="col-lg-12 col-md-12 col-sm-12 form-group"
                            style="display: flex; justify-content: center;">
                            <button class="theme-btn btn-style-one" type="submit" >Suivant</button>
                        </div>
                </div>
                </form>
            </div>
...
=======
                                            <a href="#" class="theme-btn btn-style-three"
                                                onclick="selectOffer(this, 'Standard')">Sélectionner</a>
                                        </div>
                                    </div>
                                </div>
                                <<<<<<< HEAD=======>>>>>>> master
                                    ...
                                    <div class="pricing-table tagged col-lg-4 col-md-6 col-sm-12">
                                        <div class="inner-box">
                                            ...
                                            <div class="table-footer">
                                                <a href="#" class="theme-btn btn-style-three"
                                                    onclick="selectOffer(this, 'Gold')">Sélectionner</a>
                                            </div>
                                        </div>
                                    </div>
                                    <<<<<<< HEAD=======>>>>>>> master
                                        ...
                                        <div class="pricing-table col-lg-4 col-md-6 col-sm-12">
                                            <div class="inner-box">
                                                ...
                                                <div class="table-footer">
                                                    <a href="#" class="theme-btn btn-style-three"
                                                        onclick="selectOffer(this, 'Premium')">Sélectionner</a>
                                                </div>
                                            </div>
                                        </div>
>>>>>>> 40fc94a (Initial commit)
...
=======
                <<<<<<< HEAD <!-- Hidden input to store selected offer -->
                    <input type="hidden" id="selected-offer" name="selected_offer" value="">
