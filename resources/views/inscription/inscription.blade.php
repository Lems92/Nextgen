          ...
          <form method="post" action="{{ route('inscription.post') }}">
            ...
            <div class="form-group">
              ...
              <div class="form-group mt-4">
                  ...
                  <x-text-input id="email" class="block mt-1 w-full" type="email" placeholder="Adresse email" name="email"
              ...
              <div class="form-group mt-4">
                  ...
                  <x-text-input id="password" class="block mt-1 w-full" type="password" name="password" placeholder="Le mot de passe doit contenir au moins 6 caractères*" required
              ...
              <div class="form-group mt-4">
                  ...
                  <x-text-input id="password_confirmation" class="block mt-1 w-full" type="password"
                                name="password_confirmation" placeholder="Veuillez confirmer votre mot de passe" required autocomplete="new-password" />
