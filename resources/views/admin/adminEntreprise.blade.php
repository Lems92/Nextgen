    ...
    <section id="details-entreprise" class="p-4 border rounded shadow-sm" style="display:none;">
        ...
        <form>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="address2" placeholder="Bâtiment, Appartement, Suite">
            </div>
            ...
            <div class="mb-3">
                ...
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" value="underrepresented" id="underrepresented">
                    <label class="form-check-label" for="underrepresented">Programmes pour Groupes Sous-représentés</label>
                </div>
                <div class="form-check">
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <div class="pricing-plan">
                                <div class="plan-header">
                                    <h4>Plan Standard</h4>
                                    <p>prix: <input type="text" class="form-control" placeholder="5030000" >Ar/mois</p>
                                </div>
                                <div class="plan-features">
                                    <ul>
