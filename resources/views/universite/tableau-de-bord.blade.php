                                            ...
                                            <td>
                                                <div class="option-box">
                                                    <ul class="option-list">
                                                        <li>
                                                            <button data-text="View Event"><span
                                                                    class="la la-eye"></span></button>
                                                        </li>
                                                        <li>
                                                            <button data-text="Edit Event"><span
                                                                    class="la la-pencil"></span></button>
                                                        </li>
                                                        <li>
                                                            <button data-text="Delete Event"><span
                                    ...
                                    <div class="tabs-box">
                                        <div class="aplicants-upper-bar">
                                            ...
                                            <ul class="aplicantion-status tab-buttons clearfix">
                                                <li class="tab-btn active-btn totals" data-tab="#totals">Total(s): 6
                                                </li>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="candidate-block-three col-lg-6 col-md-12 col-sm-12">
                                                        <div class="inner-box">
                                                            <div class="content">
                                                                <figure class="image"><img
                                                                        src="images/resource/candidate-2.png" alt="">
                                                                </figure>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="candidate-block-three col-lg-6 col-md-12 col-sm-12">
                                                        <div class="inner-box">
                                                            <div class="content">
                                                                <figure class="image"><img
                                                                        src="images/resource/candidate-3.png" alt="">
                                                                </figure>
